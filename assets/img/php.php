...
echo "<font color=#CCFFFF>【复仇者】</font>";
}
?><br><br>
...
<font color="#00FFCC">请输入密码:<input type="password" name="pass" id="pass">
<input type="submit" name="denglu" value="确定" /></form>
<?php } ?>
